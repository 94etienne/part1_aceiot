...
const ItemsByCategory = () => {
  ...
  const fetchItems = async () => {
    try {
      ...
      let url = `http://localhost:5000/items/type/${decryptedItemTypeId}`; //DISPLAY LIST OF CLICKED ITEM TYPES ID FROM DASHBOARD
      ...
      const [itemsResponse, itemTypeResponse] = await Promise.all([
        ...
        axios.get(`http://localhost:5000/item_types/byId/${decryptedItemTypeId}`, {
